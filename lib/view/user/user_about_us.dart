        ...
        child: Column(
          ...
          children: [
            ...
            Align(
              alignment: Alignment.topCenter,
              child: Text(
                'More than just an app, CommuteSmart is a community of students, educators, and parents committed to transforming the student commute experience. Whether you are a high schooler or a university student, our platform supports your journey to and from school with smart technology and a heart for sustainability.Download CommuteSmart today and take the first step towards a smarter, safer, and more sustainable commute!',
                style: GoogleFonts.poppins(fontWeight: FontWeight.w600),
              ),
            ),
          ],
