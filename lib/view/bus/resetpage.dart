...
class ResetPageBus extends StatefulWidget {
  String phone;
  ResetPageBus({super.key, required this.phone});

  @override
  State<ResetPageBus> createState() => _ResetPageBusState();
}

class _ResetPageBusState extends State<ResetPageBus> {
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    if (querySnapshot.docs.isNotEmpty) {
                      ...
                      _showDialog('Error', 'No user found with this phone number.');
                    }
                  });
                    }
                  },
